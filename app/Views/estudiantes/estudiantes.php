<div class="container bg-white rounded rounded-3">
    <div class="d-flex justify-content-between flex-wrap">
        ...
        <div class="table-responsive" style="max-height:80vh;">
            <table style="text-align: center;" id="tablaEstudiantes" class="table align-items-center table-flush table-loader">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col">
                        ...
                        <div class="input-group">
                            ...
                            <button class="btn btn-success" type="button" id="btn_insertar" title="Agregar Email"><i class="bi bi-plus"></i></button>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col">
                        ...
                        <div class="input-group">
                            ...
                            <button class="btn btn-success" type="button" id="btn_insertarTelefono" title="Agregar Email"><i class="bi bi-plus"></i></button>
...
<script>
    ...
    function seleccionaUsuario(id, tp) {
        if (tp == 2) {
            ...
            $('#formulario').validate().resetForm();
            $('#tituloModal').text('Añadir Estudiante');
            $('#direccionX').val('');
