          ...
          <?php foreach ($datos as $valor) { ?>
            <tr>
              ...
              <th class="grid grid text-center" colspan="2">
                <button class="btn btn-outline-warning" data-bs-toggle="modal" data-bs-target="#modal-confirma" data-href="<?php echo base_url('/roles/cambiarEstado') . '/' . $valor['id_rol'] . '/' . 'A'; ?>" title="Restaurar"><i class="bi bi-arrow-clockwise"></i></button>
              </th>
