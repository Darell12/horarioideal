<div class="container bg-white rounded rounded-3">
  <div class="d-flex justify-content-between flex-wrap">
    ...
    <div>
      <a href="<?php echo base_url('/ver_roles'); ?>"><button class="btn btn-outline-primary"><i class="bi bi-arrow-return-left"></i> Regresar</button></a>
    </div>
  </div>
  <br>
  <div class="table-responsive">
    <table class="table align-items-center table-flush" id="tablaRoles" width="100%" cellspacing="0">
...
<script>
  ...
  function Restaurar(id) {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo base_url('/roles/cambiarEstado/'); ?>" + id + '/' + 'A',
      dataType: "json",
    }).done(function(data) {
      ...
      },
      {
        ...
        render: function(data, type, row) {
          return `<div class="btn-group container">
                              <button class="btn btn-outline-warning" data-bs-toggle="modal" data-bs-target="#modal-confirma" title="Resetear Contraseña" data-href="${data.id_rol}"><i class="bi bi-arrow-clockwise"></i></button>
                         </div>`
        },
      }
    ],
